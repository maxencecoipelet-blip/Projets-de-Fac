...
function vecteur(MaScene,A,B,CoulHexa,longCone,RayopnCone){
 var vecAB = new THREE.Vector3( B.x-A.x, B.y-A.y, B.z-A.z );
 vecAB.normalize();
 MaScene.add( new THREE.ArrowHelper( vecAB, A, B.distanceTo(A), CoulHexa,longCone,RayopnCone ));
}*/


/*
// tracage a la main, courbe de Bezier quadratique
function Bez2(MaScene,nb,P0,P1,P2,CoulHexa,epai){
...
*/
/*
// tracage a la main, courbe de Bezier cubique
function Bez3(MaScene,nb,P0,P1,P2,P3,CoulHexa,epai){
  var geometry = new THREE.Geometry();
    for(var k=0;k<=nb;k++){
       var t2=k/nb; 
       t2=t2.toPrecision(PrecisionArrondi);
       ...
       v0.addScaledVector(P0,Ber(t2,0,3));
       v1.addScaledVector(P1,Ber(t2,1,3));
       v2.addScaledVector(P2,Ber(t2,2,3));
       v3.addScaledVector(P3,Ber(t2,3,3));
       v0.add(v1);
       v0.add(v2);
       v0.add(v3);
       geometry.vertices.push(v0);
