 function cameraLumiere(scene,camera){   // creation de la camera 
  ...
  var yPos=-12;//document.forms["controle"].PosY.value;//*document.forms["controle"].zoom.value;
  ...
  //actuaPosCameraHTML(camera,xPos, yPos, zPos,xDir, yDir, zDir);
    //camera.lookAt(scene.position);
    //camera.lookAt(new THREE.Vector3(0,0,0));
} // fin fonction cameraLumiere
 
 function actuaPosCameraHTML(camera,xPos, yPos, zPos,xDir, yDir, zDir){
